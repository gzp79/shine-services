use crate::math::value::{AnimatedVariable, TweenLike, ValueError, ValueKind, ValueType, Variable};
...
impl<T> Variable for NamedValue<T>
where
    T: Variable,
{
...
impl<T> AnimatedVariable for NamedValue<T>
where
