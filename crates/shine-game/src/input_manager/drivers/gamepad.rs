...
impl InputProcessor for GamepadButtonInput {
...
impl TypedInputProcessor<bool> for GamepadButtonInput {
...
impl InputProcessor for GamepadStickInput {
    fn name(&self) -> Cow<'_, str> {
        self.name
            .as_deref()
...
impl TypedInputProcessor<Vec2> for GamepadStickInput {
