...
impl<I> InputProcessor for NormalizedPosition<I>
where
    I: TypedInputProcessor<Vec2>,
{
...
impl<I> TypedInputProcessor<Vec2> for NormalizedPosition<I>
where
    I: TypedInputProcessor<Vec2>,
{
...
impl<I> InputProcessor for ScreenEdgeScroll<I>
where
    I: TypedInputProcessor<Vec2>,
{
    fn name(&self) -> Cow<'_, str> {
...
impl<I> TypedInputProcessor<Vec2> for ScreenEdgeScroll<I>
where
    I: TypedInputProcessor<Vec2>,
{
    fn process(&mut self, time_s: f32) -> Option<Vec2> {
...
/// Trait to extend `InputProcessor` with screen position processing capabilities.
pub trait ScreenPositionProcess: TypedInputProcessor<Vec2> {
...
impl<T> ScreenPositionProcess for T where T: TypedInputProcessor<Vec2> + Sized {}
