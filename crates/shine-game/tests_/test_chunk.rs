...
trait TestCase {
    ...
    fn layer(&self, command_queue: ChunkCommandQueue<Self::Chunk, Self::Operation, Self::Hasher>) -> impl LayerSetup;
    ...
    T: TestCase,
{
    ...
    let command_queue = {
        ...
        app.add_plugins(DefaultPlugins).add_plugins(
            MapPlugin::new(MapConfig { width: WIDTH, height: HEIGHT })
