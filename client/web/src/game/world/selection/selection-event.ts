...
export function selectionOwner(sel: Selection): Chunk | ChunkEdge | ChunkCorner {
    return sel.type === 'cell' ? sel.chunk : sel.type === 'edge-cell' ? sel.edge : sel.corner;
}

export function isSelectionInteractable(sel: Selection, reference: ChunkId): boolean {
