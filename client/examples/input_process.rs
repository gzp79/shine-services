...
use shine_game::{
    application,
    input_manager::{
        ActionStates, ButtonChord, ButtonCompose, DualAxisChord, DualAxisCompose, InputManagerPlugin, InputMap,
...
fn show_status(mut players: Query<(&InputMap<Action>, &ActionStates<Action>, &mut Text)>, window: Query<&Window>) {
