...
export function createControls(
  ...
  gui.add(orientObj, "odd").name("odd orientation").onChange((v: boolean) => {
  ...
  btn.style.cssText = "flex:1;height:var(--widget-height);cursor:pointer;border:none;background:var(--widget-color);color:var(--text-color);font-family:inherit;font-size:inherit;border-radius:var(--widget-border-radius);";
